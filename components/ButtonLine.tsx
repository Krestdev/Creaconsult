  ...
  return (
    <div className=" z-[1] pt-[40px] pb-[15px] pl-[15px] flex relative ">
      <div className=" relative">
        <a
          className=" border-[#ffffffab] duration-300 hover:bg-[--primary-transparent] bg-[#dcc5b700] tracking-[0.5px] uppercase border-[1px] border-solid py-[10px] px-[40px] text-[12px] font-semibold leading-[24px] cursor-pointer rounded-none no-underline inline-block"
          href=""
        >
          {text}
        </a>
