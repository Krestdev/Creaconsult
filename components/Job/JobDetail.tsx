        ...
        <>
          <div className="flex gap-4 justify-center items-start flex-col">
            ...
            >
              ...
              {!Job.expire || new Date(Job.expire) > now
                ? dictionary.JobsDetail.actif
                : dictionary.JobsDetail.expire}
            </button>
          </div>
          ...
          <div className="flex">
            <div className="md:w-2/3 w-full">
              <div className="space-y-4 my-[24px]">
                <div>
                  <h3 className="font-semibold hidden md:block">
                    {dictionary.JobsDetail.competence}
                  </h3>
              ...
              <div className="flex gap-4 flex-col md:flex-row md:items-center">
                <Button
                  disabled={new Date(Job.expire) <= now}
                  className={`${new Date(Job.expire) <= now ? "cursor-not-allowed" : ""}`}
                >
                  <Link
                ...
                >
                  <Suitcase size={16} />
                  {isCopied
                    ? dictionary.JobsDetail.copie
                    : dictionary.JobsDetail.copier}
                </button>
              </div>
            </div>
          </div>
