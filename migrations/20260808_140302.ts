...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "jobs" (
  	...
  	"expire" timestamp(3) with time zone,
  ...
  ALTER TABLE "jobs_tags" ADD CONSTRAINT "jobs_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."jobs"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "jobs" ADD CONSTRAINT "jobs_illustration_id_media_id_fk" FOREIGN KEY ("illustration_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "jobs_tags_order_idx" ON "jobs_tags" USING btree ("_order");
  CREATE INDEX "jobs_tags_parent_id_idx" ON "jobs_tags" USING btree ("_parent_id");
  CREATE INDEX "jobs_illustration_idx" ON "jobs" USING btree ("illustration_id");
