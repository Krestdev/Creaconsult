...
const formSchema = z.object({
    ...
    addresse: z.string(),
    poste: z.string(),
    lettre: z.instanceof(FileList).optional(),
});

function Submit({ JobData, dictionary }: { JobData: any, dictionary: Dictionary } ) {
                ...
                <Form {...form}>
                    ...
                    >
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder={dictionary.JobsDetail.JobSubmit.nom} {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>{dictionary.JobsDetail.JobSubmit.diplome}</FormLabel>
                                    <FormControl>
                                        <Input
                                            type="file"
                                            {...diplomeRef}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>{dictionary.JobsDetail.JobSubmit.addresse}</FormLabel>
                                    <FormControl>
